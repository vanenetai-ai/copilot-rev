...
const en = {
  ...
  responsesWebSearchToggle: "Enable Responses web_search tool",
  responsesWebSearchHint: "When disabled, web_search tools in /v1/responses requests are stripped before forwarding upstream.",
  responsesApplyPatchToggle: "Enable Responses apply_patch adaptation",
  responsesApplyPatchHint: "When enabled, custom apply_patch tools in /v1/responses are converted to function tools before forwarding upstream.",
  preferNativeMessagesToggle: "Prefer native Messages by model",
  preferNativeMessagesHint: "When enabled, /v1/messages requests use upstream native messages endpoint first if the selected model advertises messages support.",
  proxySaved: "Saved",
  proxyClear: "Clear",
...
const zh: Translations = {
  ...
  responsesWebSearchToggle: "启用 Responses 的 web_search 工具",
  responsesWebSearchHint: "关闭后，/v1/responses 请求中的 web_search 工具会在转发上游前被移除。",
  responsesApplyPatchToggle: "启用 Responses 的 apply_patch 适配",
  responsesApplyPatchHint: "开启后，/v1/responses 中自定义的 apply_patch 工具会在转发前转换为 function 工具。",
  preferNativeMessagesToggle: "按模型优先走原生 Messages",
  preferNativeMessagesHint: "开启后，/v1/messages 请求会优先根据模型能力走上游原生 messages 端点；不支持时自动回退。",
  proxySaved: "已保存",
  proxyClear: "清除",
